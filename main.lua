...
_Clear.Position = UDim2.new(0, 10, 1, -60)
_Clear.NextSelectionRight = nil
_Clear.Size = UDim2.new(0.5, -20, 0, 50)
_Clear.Name = "Clear"
...
______________________UIStroke.Parent = _MainFrame
...
___Close.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
...
___Close.Parent = _MainFrame
___Close.TextColor3 = Color3.fromRGB(255, 255, 255)
___Close.NextSelectionUp = nil
___Close.Position = UDim2.new(0, 5, 0, -5)
___Close.AnchorPoint = Vector2.new(0, 1)
___Close.Visible = false
___Close.NextSelectionRight = nil
___Close.Size = UDim2.new(0, 50, 0, 50)
___Close.Name = "Close"
...
_Path.Active = true
_Path.ZIndex = 2
_Path.BorderSizePixel = 0
_Path.NextSelectionDown = nil
_Path.TextSize = 14
_Path.TextWrapped = true
_Path.TextScaled = true
_Path.BackgroundColor3 = Color3.fromRGB(24, 0, 48)
_Path.TextColor3 = Color3.fromRGB(255, 255, 255)
_Path.FontFace = Font.new("rbxasset://fonts/families/Inconsolata.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal)
_Path.RootLocalizationTable = nil
_Path.Parent = _SavePrompt
_Path.Name = "Path"
_Path.NextSelectionRight = nil
_Path.PlaceholderText = "Enter script name"
_Path.NextSelectionUp = nil
_Path.NextSelectionLeft = nil
_Path.BorderColor3 = Color3.fromRGB(0, 0, 0)
_Path.Text = ""
_Path.Size = UDim2.new(0.8999999761581421, 0, 0.20000000298023224, 0)
...
___Save.Active = true
___Save.ZIndex = 2
___Save.BorderSizePixel = 0
___Save.TextScaled = true
___Save.BackgroundColor3 = Color3.fromRGB(24, 0, 48)
___Save.FontFace = Font.new("rbxasset://fonts/families/Inconsolata.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal)
___Save.TextSize = 14
___Save.Parent = _SavePrompt
___Save.TextColor3 = Color3.fromRGB(255, 255, 255)
___Save.NextSelectionUp = nil
___Save.Position = UDim2.new(0, 5, 0.5, 5)
___Save.NextSelectionRight = nil
___Save.Size = UDim2.new(1, -10, 0.25, -10)
___Save.Name = "Save"
___Save.BorderColor3 = Color3.fromRGB(0, 0, 0)
___Save.Text = "Save"
___Save.NextSelectionLeft = nil
___Save.NextSelectionDown = nil
___Save.RootLocalizationTable = nil
___Save.SelectionImageObject = nil

--___________________UIStroke
___________________UIStroke.Color = Color3.fromRGB(127, 0, 255)
...
__Close.BackgroundColor3 = Color3.fromRGB(24, 0, 48)
__Close.FontFace = Font.new("rbxasset://fonts/families/Inconsolata.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal)
__Close.TextSize = 14
__Close.Parent = _SavePrompt
__Close.TextColor3 = Color3.fromRGB(255, 255, 255)
__Close.NextSelectionUp = nil
__Close.Position = UDim2.new(0, 5, 0.75, 5)
__Close.NextSelectionRight = nil
__Close.Size = UDim2.new(1, -10, 0.25, -10)
__Close.Name = "Close"
...
task.spawn(function()
	...
	local lastPlace = script.Parent.Position
	script.Parent.Menu.MouseButton1Click:Connect(function()
		if debounce then
			...
			if enabled then
				lastPlace = script.Parent.Position
				...
				script.Parent:TweenSizeAndPosition(UDim2.new(0, 100, 0, 100), lastPlace, Enum.EasingDirection.Out, Enum.EasingStyle.Quint, 1, true)
			end
			task.wait(1)
			if enabled then
...
task.spawn(function()
	...
	script.Parent.Save.MouseButton1Click:Connect(function()
		script.Parent.Visible = false
		script.Parent.Parent.Save.Visible = true
	end)
end)
task.spawn(function()
